...
## Project Structure
    ...
    ├── sparkling_wildflowe_95602  # Django project configurations
...
1. Clone this repo and `cd sparkling_wildflowe_95602`
...
2. Clone this repo and `cd sparkling_wildflowe_95602`
